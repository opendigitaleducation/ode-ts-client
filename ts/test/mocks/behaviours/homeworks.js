...
/***/ (function(module, exports, __webpack_require__) {
	...
	console.log('homeworks behaviours loaded');
	var homeworksBehaviours = {
	    resources: [],
	    rights: {
	        workflow: {
	            view: 'fr.wseduc.homeworks.controllers.HomeworksController|view',
	            create: 'fr.wseduc.homeworks.controllers.HomeworksController|createHomework'
	        },
	        resource: {
	            read: { right: "fr-wseduc-homeworks-controllers-HomeworksController|getHomework" },
	            contrib: { right: "fr-wseduc-homeworks-controllers-HomeworksController|updateHomeworks" },
	            manager: { right: "fr-wseduc-homeworks-controllers-HomeworksController|addRights" }
	        },
	    },
	    dependencies: {},
	    ...
	    loadResources: function () {
	        return __awaiter(this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0: return [4 /*yield*/, axios_1.default.get('/homeworks/list')];
	                    case 1:
	                        homeworks = _a.sent();
	                        homeworksBehaviours.resources = entcore_2._.map(entcore_2._.where(homeworks.data, { trashed: 0 }), function (homework) {
	                            homework.icon = homework.icon || '/img/illustrations/homeworks.svg';
	                            return {
	...
	entcore_1.Behaviours.register('homeworks', homeworksBehaviours);
